            ...
            >
              ...
              <div className="flex flex-col flex-1 justify-between gap-2 w-full">
                ...
                <div className="flex items-center gap-2 mt-2">
                  <button
                    onClick={() => product._id && dispatch(decreaseItem(product._id))}
                  ...
                  <button
                    onClick={() => product._id && dispatch(increaseItem(product._id))}
              ...
              <div className="flex flex-col gap-2 mt-4 md:mt-0">
                ...
                <button
                  onClick={() => product._id && dispatch(removeItem(product._id))}
